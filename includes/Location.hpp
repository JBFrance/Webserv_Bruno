...
struct Location
{
    ...
    void inherit(t_str root, std::vector<t_str> index, bool autoindex, unsigned long int clientMaxBodySize, std::vector<t_str> allowMethods, std::map<t_str, t_str> cgi, std::string uploadDir, t_str path);
